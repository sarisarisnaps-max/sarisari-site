      ...
      <div className="mx-auto max-w-6xl px-5">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <a
            ...
            className="rounded-full bg-primary px-6 py-3 font-mono text-sm font-semibold uppercase tracking-wide text-ink shadow-card transition hover:bg-primary-hover"
          >
            Build yours
          </a>
        </div>
          ...
          {SKUS.map((sku) => (
            <div
              ...
              className={`flex items-center gap-4 rounded-xl border p-5 ${
                sku.popular
                  ? 'border-selected bg-card shadow-lift'
